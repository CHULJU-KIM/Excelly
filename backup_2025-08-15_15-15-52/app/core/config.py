...
class Settings:
    ...
    GEMINI_PRO_MODEL: str = "gemini-2.5-pro"  # Target primary (falls back if not available)
    GEMINI_FLASH_MODEL: str = "gemini-2.5-flash"  # Target primary (falls back if not available)
    GEMINI_2_0_PRO_FALLBACK: str = "gemini-2.0-pro"  # Fallback tier 1
    GEMINI_2_0_FLASH_FALLBACK: str = "gemini-2.0-flash"  # Fallback tier 1
    GEMINI_1_5_PRO_FALLBACK: str = "gemini-1.5-pro"  # Fallback tier 2
    GEMINI_1_5_FLASH_FALLBACK: str = "gemini-1.5-flash"  # Fallback tier 2
