...
class SessionService:
            ...
            for key, value in kwargs.items():
                if hasattr(db_session, key):
                    if key == "metadata" and isinstance(value, dict):
                        setattr(db_session, "metadata_json", json.dumps(value))
                    else:
    ...
    def update_conversation_context(self, session_id: str, conversation_context: Any) -> bool:
        ...
        try:
            ...
            return self.update_session(session_id, conversation_context=context_dict)
        except Exception as e:
            return False
        ...
        try:
            ...
            if session and session.metadata.get("conversation_context"):
                ...
                return ConversationContext(
                    ...
                    pending_clarifications=[],  # Will be regenerated if needed
