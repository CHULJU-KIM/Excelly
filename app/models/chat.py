...
class ChatSession(BaseModel):
    ...
    selected_sheet: Optional[str] = Field(None, description="Selected sheet name")
...
class AIResponse(BaseModel):
    ...
    model_info: Optional[Dict[str, Any]] = Field(None, description="Detailed model information for display")
